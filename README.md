...
**Latest Version:** [v1.17.0](https://github.com/HorizenOfficial/Sphere_by_Horizen/releases/tag/desktop-v1.17.0)
...
* It is highly recommended to verify the authenticty of the downloaded files before installing them by checking the PGP signatures. Alternatively you can verify the file integrity by calculating the checksums. You may do so by following the instructions provided [here](https://github.com/HorizenOfficial/Sphere_by_Horizen/blob/desktop-v1.17.0/VERIFY_AUTHENTICITY.md).
